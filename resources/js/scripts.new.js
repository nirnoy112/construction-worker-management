$(function() {
    ...
    $('#ohs-clock-out-link').click(function(e) {
        ...
        var currentT = currTime.getTime();
         ...
         $('#co-current-time').html(currTime.toLocaleTimeString());
        ...
        if(codTime != 0) {
            ...
            var currentTime = Math.ceil(currentT / 60000);
