...
<html>
    ...
    <body style="background: #808080;">
    	<div style="width: 32%; margin-top: 15px; margin-left: 34%; background: #ffffff; border: 5px solid #38247B;" class="login-box">
            ...
            <h3 style="text-align: center; min-height: 248px; padding-top:50px; color: red;"><?php echo $errorMessage; ?></h3>
            ...
            <div class="setting_inner_input">
                <p id="rpError" style="color: red;"></p>
            </div>
            <div class="uac-form">
                <form id="rpForm" method="post" action="">
                    ...
                    <div class="col-md-10">
                        ...
                        <div class="form-group">
                            <input type="text" id="password1" name="password" value="<?php echo $this->input->post('password'); ?>" class="form-control" />
                        </div>
                        <label for="password" class="control-label">RE-ENTER NEW PASSWORD</label>
                        <div class="form-group">
                            <input type="text" id="password2" name="re-password" value="<?php echo $this->input->post('re-password'); ?>" class="form-control" />
                        </div>
                    </div>
                    <div class="col-md-1">
                    </div>
                    ...
                    <div class="box-footer">
                        <button type="submit" id="reset_password" class="btn btn-success"><i class="fa fa-check"></i> RESET PASSWORD</button>
                    </div>
                </form>
            </div>
        ...
        <script src="<?php echo site_url('resources/js/webcamjs/webcam.js');?>"></script>
