...
?>
<div id="addSupplyOrderModal" class="modal">
    <div class="modal-dialog" style="width: 75%; display: block; padding: 30px;">
        <div class="modal-content">
            <div class="modal-header">
                <!-- header section -->
                <h4 class="modal-heading">ADD INVENTORY ORDER</h4>
            </div>
            <div class="row modal-body" style="padding: 0px 25px 0px 25px;">
                ...
                <input type="hidden" name="order[createdBy]" value="<?php echo $user_session['realName'] . ' (' . $user_session['username'] . ')'; ?>" id="createdBy" />
	          	<div class="box-body">
	          		<div class="row clearfix">
	          			...
	          			<div style="text-align: left;" class="col-sm-5">
	          				...
	          				<div class="col-md-8">
	          					<div class="form-group">
									<input type="text" name="order[osLocation]" value="<?= $site['siteName']; ?>" class="form-control" id="osLocation" />
								</div>
	          				</div>
	          				<div class="col-md-4">
	          				...
	          				<div class="col-md-8">
	          					<div class="form-group">
									<input type="text" name="order[osAddressLine1]" value="<?= $site['address1']; ?>" class="form-control" id="osAddressLine1" />
								</div>
							</div>
							<div class="col-md-4">
	          				</div>
	          				<div class="col-md-8">
	          					<div class="form-group">
									<input type="text" name="order[osAddressLine2]" value="<?php if($site['city']) { echo $site['city'] . ', ' ; } if($site['state']) { echo $site['state'] . ' '; }if($site['zipCode']) { echo $site['zipCode'] . '.'; } ?>" class="form-control" id="osAddressLine2" />
								</div>
							</div>
	          			</div>
	          			<div class="col-sm-12">
	          			...
	          			<div class="col-md-12">
	          				<table class="table table-striped">
			                    ...
			                    <tr>
									...
									<td><code><?= $official_supplies[$counter]['description']; ?></code><input type="hidden" name="os[<?= $counter ?>][description]" value="<?php echo $official_supplies[$counter]['description']; ?>" id="os-description-<?= $counter; ?>" /></td>
									<th style="width: 8%;"></th>
									<td><input type="text" name="os[<?= $counter ?>][quantity]" value="<?= $official_supplies[$counter]['quantity']; ?>" size="6" class="form-control" id="os-quantity-<?= $counter; ?>" /></td>
									<th style="width: 8%;"></th>
			                        <td><input type="text" name="os[<?= $counter ?>][unitPrice]" value="<?= sprintf("%.2f", $official_supplies[$counter]['unitPrice']); ?>" size="6" class="form-control" id="os-unitPrice-<?= $counter; ?>" /></td>
									<th style="width: 8%;"></th>
			                        <td><input type="text" name="os[<?= $counter ?>][lineTotal]" value="<?= sprintf("%.2f", $official_supplies[$counter]['lineTotal']); ?>" size="8" class="form-control" id="os-lineTotal-<?= $counter; ?>" /></td>
			                    </tr>
			                    <?php
			                    		$counter = $counter + 1;
	          			...
	          			<div style="text-align: left;" class="col-sm-5">
	          				...
	          				<div class="col-md-8">
	          					<div class="form-group">
									<input type="text" name="order[msLocation]" value="<?= $site['siteName']; ?>" class="form-control" id="msLocation" />
								</div>
	          				</div>
	          				<div class="col-md-4">
	          				...
	          				<div class="col-md-8">
	          					<div class="form-group">
									<input type="text" name="order[msAddressLine1]" value="<?= $site['address1']; ?>" class="form-control" id="msAddressLine1" />
								</div>
							</div>
							<div class="col-md-4">
	          				</div>
	          				<div class="col-md-8">
	          					<div class="form-group">
									<input type="text" name="order[msAddressLine2]" value="<?php if($site['city']) { echo $site['city'] . ', ' ; } if($site['state']) { echo $site['state'] . ' '; }if($site['zipCode']) { echo $site['zipCode'] . '.'; } ?>" class="form-control" id="msAddressLine2" />
								</div>
							</div>
	          			</div>
	          			<div class="col-sm-12">
	          	...
	          	<div class="box-footer">
	            	<button type="submit" name="save_inventory_order" id="save_inventory_order" value="save_inventory_order" class="btn btn-success">SAVE</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button type="submit" id="cancel_supply_order" name="cancel_supply_order" value="cancel_supply_order" class="btn btn-warning">CANCEL</button>
	          	</div>
	            <?php echo form_close(); ?>
            </div>
        </div>
