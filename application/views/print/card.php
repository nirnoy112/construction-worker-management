					...
					<tr>
						<td rowspan="2" style="width:28%; float:left; text-align: left;">
							...
							?>
									...
									<img src="<?php echo $w['imageURI'];?>" style="height: 102px; width: 85px;" alt="Worker Image">
							...
							?>
									...
									<img src="<?php echo site_url('resources/img/user_default.png');?>" style="height: 102px; width: 85px;" alt="Worker Image">
						...
						<td style="width: 45%; font-size: 100%; font-family: Arial Narrow; text-align: left;">
							<i><?php echo $w['lastName'] . ' ' . $w['firstName'] . ' ' . $w['middleName']; ?></i>
							<p style="font-size: 75%;"><?php echo $w['jobTitle']; ?></p><br>
							<small><?php echo $w['city'] . ', ' . $w['state'] . ' ' . $w['zipCode']; ?></small>
						</td>
						<td style="width:27%; float: right; text-align: right;">
							<img src="<?php echo base_url('utility/getqrcode/' . $w['uid']);?>" alt="QRcode" height="80" width="80">
						</td>
					</tr>
					<tr>
