...
<html>
    <head>
        ...
        <!-- Bootstrap 3.3.6 -->
        <link rel="stylesheet" href="<?php echo site_url('ohs/resources/css/bootstrap.min.css');?>">
        <!-- Font Awesome -->
        <link rel="stylesheet" href="<?php echo site_url('ohs/resources/css/font-awesome.min.css');?>">
        <!-- Ionicons -->
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/ionicons/2.0.1/css/ionicons.min.css">
        <!-- Datetimepicker -->
        <link rel="stylesheet" href="<?php echo site_url('ohs/resources/css/bootstrap-datetimepicker.min.css');?>">
        <link rel="stylesheet" href="<?php echo site_url('ohs/resources/css/bootstrap-datepicker.css');?>">
        <link rel="stylesheet" href="<?php echo site_url('ohs/resources/css/bootstrap-timepicker.min.css');?>">
        <!-- Theme style -->
        <link rel="stylesheet" href="<?php echo site_url('ohs/resources/css/AdminLTE.min.css');?>">
        <!-- AdminLTE Skins. Choose a skin from the css/skins
             folder instead of downloading all of them to reduce the load. -->
        <link rel="stylesheet" href="<?php echo site_url('ohs/resources/css/_all-skins.min.css');?>">
        <link rel="stylesheet" href="<?php echo site_url('ohs/resources/css/sigpad/sigpad.css?v=' . time());?>">
        <link rel="stylesheet" href="<?php echo site_url('ohs/resources/css/styles.css');?>">


        <script src="<?php echo site_url('ohs/resources/js/sigpad/sigpad.js');?>"></script>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        ...
        <div class="wrapper">
            <header style="height: 70px;" class="main-header">
                ...
                <a href="" class="logo">
                    ...
                    <span style="color: #38247B;"  class="logo-mini"><img src="<?php echo site_url('ohs/resources/img/ohs_logo.jpg');?>" alt="" height="70" width="70">&nbsp;OHS TRAINING & CONSULTING, INC.</span>
                    <!-- logo for regular state and mobile devices -->
                    <span style="color: #38247B;" class="logo-lg"><img src="<?php echo site_url('ohs/resources/img/ohs_logo.jpg');?>" alt="" height="70" width="70">&nbsp;OHS TRAINING & CONSULTING, INC.</span>
                </a>
                        ...
                        <!-- User Account: style can be found in dropdown.less -->
                            <li style="padding-top:20px;" class="dropdown user user-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    <span><img src="<?php echo site_url('ohs/resources/img/user.jpg');?>" class="user-image" alt="User Image"></span>
                                    <span style="color: #38247B;" class="hidden-xs"><?php echo $user_session['username']; ?></span>
                                </a>
                                <ul class="dropdown-menu">
                                    <!-- User image -->
                                    <li class="user-header">
                                       <img src="<?php echo site_url('ohs/resources/img/user_default.png');?>" class="img-circle" alt="User Image">
                ...
                <section class="sidebar">
                    ...
                    <div class="user-panel">
                        <div class="pull-left image">
                            <img src="<?php echo site_url('ohs/resources/img/user1.png');?>" class="img-circle" alt="User Image">
                        </div>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <!-- <li>
                            ...
                            ?>
                                ...
                                <!-- <li>
                                    <a href="<?php //echo site_url('drug_screening/index'); ?>"><i class="fa fa-stethoscope"></i> Drug Screenings</a>
                                </li> -->
                            <?php
        ...
        <!-- jQuery 2.2.3 -->
        <script src="<?php echo site_url('ohs/resources/js/jquery-2.2.3.min.js');?>"></script>
        <!-- Bootstrap 3.3.6 -->
        <script src="<?php echo site_url('ohs/resources/js/bootstrap.min.js');?>"></script>
        <!-- FastClick -->
        <script src="<?php echo site_url('ohs/resources/js/fastclick.js');?>"></script>
        <!-- AdminLTE App -->
        <script src="<?php echo site_url('ohs/resources/js/app.min.js');?>"></script>
        <!-- AdminLTE for demo purposes -->
        <script src="<?php echo site_url('ohs/resources/js/demo.js');?>"></script>
        <!-- DatePicker -->
        <script src="<?php echo site_url('ohs/resources/js/moment.js');?>"></script>
        <script src="<?php echo site_url('ohs/resources/js/bootstrap-datetimepicker.min.js');?>"></script>
        <script src="<?php echo site_url('ohs/resources/js/bootstrap-datepicker.js');?>"></script>
        <script src="<?php echo site_url('ohs/resources/js/bootstrap-timepicker.js');?>"></script>
        <script src="<?php echo site_url('ohs/resources/js/global.js');?>"></script>

        <script src="<?php echo site_url('ohs/resources/js/webcamjs/webcam.js');?>"></script>

        <script src="<?php echo site_url('ohs/resources/js/scripts.js?v=' . time());?>"></script>
    </body>
</html>
