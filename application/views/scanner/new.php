                ...
                <div class="row clearfix">
                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-4">
                            ...
                            <div id="scanner_results" ></div>

                            <br>

                            <div style=" padding-left: 20px; text-align: center;">
                                <input type="button" id="scan_snapshot" value="Scan">
                            </div>

                            <input type="hidden" id="scannerPictureDataURI" name="scannerPictureDataURI" value="">
                        </div>
                        <div class="col-sm-5">
                            
                            
                            <div id="ohs_scanner_webcam" style="height: 200px; width: 400px; align-content: center; border: 0.5px solid skyblue;">
                                <div style="padding-top: 90px; text-align: center;">
                                    <a name="capture_scanner_picture" id="capture_scanner_picture" class="btn btn-info" href="">
                                        <i class="fa fa-camera-retro"></i> CAPTURE PICTURE
                                    </a>
                                </div>
                            </div>
                            ...
                            <div style=" padding-left: 40px; text-align: center;"><input type="button" id="take_scanner_snapshot" value="Take Snapshot"></div>
                        ...
                        <div style="padding-top: 20px; height: 240px; border-left: 1px solid #333333;" class="col-sm-3">
