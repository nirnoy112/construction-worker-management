...
<div id="drugScreeningModal" class="modal">
    <div class="modal-dialog" style="width: 950px !important; display: block; padding: 15px;">
        <div class="modal-content">
            <div class="modal-header">
                <!-- header section -->
                <h4 class="modal-heading">ADD NEW DRUG SCREENING</h4>
            </div>
...
<p style="font-family:candara; font-size: 130%;">I understand that the results of this test is shared with <span class="assigning-company-name"></span> Safety Department, and that signing this document is consent to both the collection of the urine and the release of the results to <span class="assigning-company-name"></span>.</p>
						...
						<div class="col-sm-12">
	          				<div class="col-md-2">
								<label for="workerName"><span style="font-size: 100%;" class="text-danger">*</span> Name (Printed):</label>
							</div>
							<div class="col-md-5">
						...
						<div class="col-sm-12">
							...
							<div class="col-md-1">
								<label for="dsSiteId" class="control-label">&nbsp;&nbsp;&nbsp;&nbsp;Site:</label>
							</div>
							<div class="col-md-4">
								<div class="form-group">
									<select id="dsSiteId" name="dsSiteId" class="form-control">
										<option value="0/">NONE</option>
										<?php 
										foreach($all_sites as $s)
										{
											$selected = ($s['id'] == $worker['siteIdW']) ? ' selected="selected"' : "";
						...
						<div id="ds-other-site" class="col-sm-12">
							...
							<div class="col-md-4">
								Site Name
								<div class="form-group">
									<input type="text" name="otherSiteName" value="<?php echo $worker['otherSiteName']; ?>" class="form-control" id="otherSiteName" />
								<span class="text-danger" name="ds-otherSiteName" id="ds-otherSiteName"></span>
								</div>
							</div>
							<div class="col-md-3">
								Contact Name
								<div class="form-group">
									<input type="text" name="otherSiteContactName" value="<?php echo $worker['otherSiteContactName']; ?>" class="form-control" id="otherSiteContactName" />
								</div>
							</div>
							<div class="col-md-2">
								Phone Number
								<div class="form-group">
									<input type="text" name="otherSitePhone" value="<?php echo $worker['otherSitePhone']; ?>" class="form-control" id="otherSitePhone" />
								</div>
							</div>
							<div class="col-md-3">
								Email
								<div class="form-group">
									<input type="text" name="otherSiteEmail" value="<?php echo $worker['otherSiteEmail']; ?>" class="form-control" id="otherSiteEmail" />
								</div>
							</div>
						</div>
	          			<div class="col-sm-12">
						...
						<div class="col-sm-12">
							...
							<div class="col-md-4">
								...
								<select name="tt1Id" class="control-label" id="tt1Id">
									<?php 
									foreach($all_non_dot_test_panels as $non_dot_test_panel)
									{
										$selected = ($non_dot_test_panel['id'] == $this->input->post('tt1Id')) ? ' selected="selected"' : "";
							...
							<div class="col-md-4">
								<input type="checkbox" id="isTT3" name="isTT3" value="YES" /><span></span> <label for="tt2">Fentanyl Dip</label>
							</div>
							<div class="col-md-2">
						...
						<div class="col-sm-12">
							...
							<div class="col-sm-3">
								<input class="control-label" type="radio" name="testResult" id="ds-negative-result" value="Negative"<?php if($this->input->post('testResult') == 'Negative') { echo ' checked'; } ?> /><b>Negative.</b>
							</div>
							<div class="col-sm-5">
								<input class="control-label" type="radio" id="ds-inconclusive-result" name="testResult" value="Inconclusive; Sent for further testing"<?php if($this->input->post('testResult') == 'Inconclusive; Sent for further testing') { echo ' checked'; } ?> /><b>Inconclusive; Sent for further testing.</b>
							</div>
							<div class="col-sm-3">
								<input class="control-label" type="radio" name="testResult" id="ds-refused-to-test-result" value="Refused To Test"<?php if($this->input->post('testResult') == 'Refused To Test') { echo ' checked'; } ?> /><b>Refused To Test.</b>
							</div>
	          			</div>
						<div <?= ($user_session['userType'] != 'ADMIN') ? 'style="display: none;"' : ''; ?> class="col-sm-12">
							...
							<div class="col-sm-3">
								<input class="control-label" type="radio" name="testResult" id="ds-cleared-result" value="Inconclusive; Cleared"<?php if($this->input->post('testResult') == 'Inconclusive; Cleared') { echo ' checked'; } ?> /><b>Inconclusive; Cleared.</b>
							</div>
							<div class="col-sm-5">
								<input class="control-label" type="radio" name="testResult" id="ds-far-result" value="FAR"<?php if($this->input->post('testResult') == 'FAR') { echo ' checked'; } ?> /><b>Not cleared for work.</b>
							</div>
	          				<div class="col-sm-3">
							</div>
						</div>
						...
						<div id="inconclusive-div" class="col-sm-12">
							...
							<div class="col-md-3">
								Specimen ID&nbsp;&nbsp;<input type="text" name="specimenId" size="8" value="<?php echo ($this->input->post('specimenId')) ? $this->input->post('specimenId') : ''; ?>" id="specimenId" />
							</div>
							<div id="test-details" class="col-md-3">
								Inconclusive Details
							</div>
							<div class="col-md-5">
								<textarea name="inconclusiveDetails" class="form-control" id="inconclusiveDetails"><?php echo ($this->input->post('inconclusiveDetails') ? $this->input->post('inconclusiveDetails') : ''); ?></textarea>
							</div>
						</div>
						<div class="col-sm-12" style="height: 10px;">
	          			</div>
						...
						<div class="col-sm-12">
							...
							<div class="col-md-7">
								<div class="sp-wrapper">
  									<canvas id="collector-signature-pad" class="signature-pad" style="width: 400px; height: 100px;"></canvas>
								</div>
							</div>
							<div style="padding-top: 35px;" class="col-md-2">
								<button id="clear-collector-signature">Clear</button>
							</div>
						</div>
						<div class="col-sm-12" style="height: 10px;">
	          			</div>
	          	...
	          	<div class="box-footer">
	            	<button type="submit" name="drug_screening_submit" id="drug_screening_submit" value="drug_screening_submit" class="btn btn-success">SUBMIT</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button type="submit" name="cancel_drug_screening" value="cancel_drug_screening" class="btn btn-warning">CANCEL</button>
	          	</div>
	            <?php echo form_close(); ?>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    var canvas = document.getElementById('worker-signature-pad');


    var collectorCanvas = document.getElementById('collector-signature-pad');
    ...
    document.getElementById('clear-collector-signature').addEventListener('click', function (e) {
    ...
    document.getElementById('drug_screening_submit').addEventListener('click', function (e) {
      ...
      document.getElementById('collectorSignature').value = collectorSignatureData;
