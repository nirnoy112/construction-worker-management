...
<p style="font-family:candara; font-size: 130%;">I understand that the results of this test is shared with <span class="assigning-company-name"></span> Safety Department, and that signing this document is consent to both the collection of the urine and the release of the results to <span class="assigning-company-name"></span>.</p>
						...
						<div class="col-sm-12" style="height: 15px;">
	          			...
	          			<div class="col-sm-12">
	          				<div class="col-md-2">
								<label for="workerName" class="control-label"><span style="font-size: 100%;" class="text-danger">*</span> Name (Printed):</label>
							</div>
							<div class="col-md-5">
							...
							<div class="col-md-4">
								<div class="form-group">
									<select id="dsSiteId" name="dsSiteId" class="form-control">
										...
										{
											$selected = ($s['id'] == $ds['dsSiteId']) ? ' selected="selected"' : "";
	          			...
	          			<div class="col-sm-12">
							...
							<div class="col-md-4">
								...
								<select name="tt1Id" class="control-label" id="tt1Id">
									...
									{
										$selected = ($non_dot_test_panel['id'] == $ds['tt1Id']) ? ' selected="selected"' : "";
