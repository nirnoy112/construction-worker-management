    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 style="color: #ffffff;" class="box-title">Company Admin Add</h3>
            </div>
            <?php echo form_open('company_admin/add'); ?>
          	<div class="box-body">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="company_id" class="form-control">
								...
								{
									$selected = ($company['id'] == $this->input->post('company_id')) ? ' selected="selected"' : "";
